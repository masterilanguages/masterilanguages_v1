...
export default function Flashcards() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'linear-gradient(160deg, #f0ece4 0%, #e8e4d8 50%, #eae6da 100%)' }}>
        <motion.div
          animate={{ rotate: 360 }}
  ...
  return (
    <div className="fixed inset-0 flex flex-col" style={{ background: 'linear-gradient(160deg, #f0ece4 0%, #e8e4d8 50%, #eae6da 100%)' }}>
      {/* Top menu bar */}
