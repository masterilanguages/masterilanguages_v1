                    ...
                    <>
                      <div className="flex flex-wrap gap-2 mb-3">
                        {words.map((w, i) => (
                          <div
                            key={i}
                            className="flex flex-col items-center px-3 py-2 rounded-lg bg-stone-50 border border-stone-200 text-center"
                          >
                            <span className="text-xs text-cyan-700 font-semibold" dir="rtl">{w.hebrew}</span>
                            <span className="text-xs text-stone-500">{w.phonetic}</span>
                            <span className="text-xs text-stone-400 italic">{w.translation}</span>
                          </div>
                        ))}
                      </div>
                      <button
