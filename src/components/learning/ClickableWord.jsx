...
export default function ClickableWord({ 
  ...
  const generateSentences = async () => {
    ...
    try {
      const result = await base44.integrations.Core.InvokeLLM({
        prompt: `Create 5 example sentences using the Hebrew word "${word}" (${transliteration}) which means "${translation}".
  ...
  const generateMnemonicSuggestions = async () => {
    ...
    try {
      const result = await base44.integrations.Core.InvokeLLM({
        prompt: `Create 3 different mnemonic image ideas to help remember the Hebrew word "${word}" (${transliteration}) which means "${translation}".
        Each mnemonic should use the SOUND of the Hebrew word to create a memorable visual scene.
  ...
  const generateMnemonicImage = async (prompt) => {
    ...
    try {
      const result = await base44.integrations.Core.GenerateImage({
        ...
        For learning Hebrew word "${transliteration}" meaning "${translation}".
              ...
              {loading ? (
                ...
                sentences.map((s, i) => (
                  ...
                  >
                    ...
                    <p className="text-lg text-cyan-400 mb-1" dir="rtl">{s.hebrew}</p>
